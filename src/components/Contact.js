...
const Contact = () => (
			<div className="card">
				...
				<p style={{ fontSize: '1.15rem', lineHeight: '1.7', marginBottom: '18px', textAlign: 'center' }}>
					Escríbenos a <a href="mailto:soporte@fastpass.com" style={{ color: '#3b82f6', textDecoration: 'underline' }}>soporte@fastpass.com</a> o utiliza el formulario a continuación.<br />
				...
				<ul className="card-list">
					<li>Instagram: <a href="https://instagram.com/fastpass" target="_blank" rel="noopener noreferrer" style={{ color: '#6366f1' }}>@fastpass</a></li>
					<li>Facebook: <a href="https://facebook.com/fastpass" target="_blank" rel="noopener noreferrer" style={{ color: '#6366f1' }}>FastPass</a></li>
				</ul>
